...
it('should call onPlayerAdd with proper name ', () => {
  const onPlayerAdd = jest.fn();
  const addPlayerComponent = mount(<AddPlayer onPlayerAdd={onPlayerAdd} />); //mount because shallow don't work with getDomNode
