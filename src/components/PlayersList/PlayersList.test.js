...
it('when button is clicked it should call onPlayerScore in Player and onScoreUpdate in PlayerList', () => {
  const players = [
    {
      name: 'Kunegunda',
      score: 5
...
it('should call onPlayerRemove - remove first player from score list', () => {
  const players = [
    {
      name: 'Kunegunda',
      score: 5
